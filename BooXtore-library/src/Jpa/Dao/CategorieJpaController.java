    ...
    public void create(Categorie categorie) {
        ...
        try {
            ...
            for (Livre livreListLivre : categorie.getLivreList()) {
                Categorie oldIdCategorieOfLivreListLivre = livreListLivre.getIdCategorie();
                livreListLivre.setIdCategorie(categorie);
                livreListLivre = em.merge(livreListLivre);
                if (oldIdCategorieOfLivreListLivre != null) {
                    oldIdCategorieOfLivreListLivre.getLivreList().remove(livreListLivre);
                    oldIdCategorieOfLivreListLivre = em.merge(oldIdCategorieOfLivreListLivre);
                }
            }
        ...
        try {
            ...
            for (Livre livreListNewLivre : livreListNew) {
                if (!livreListOld.contains(livreListNewLivre)) {
                    Categorie oldIdCategorieOfLivreListNewLivre = livreListNewLivre.getIdCategorie();
                    livreListNewLivre.setIdCategorie(categorie);
                    livreListNewLivre = em.merge(livreListNewLivre);
                    if (oldIdCategorieOfLivreListNewLivre != null && !oldIdCategorieOfLivreListNewLivre.equals(categorie)) {
                        oldIdCategorieOfLivreListNewLivre.getLivreList().remove(livreListNewLivre);
                        oldIdCategorieOfLivreListNewLivre = em.merge(oldIdCategorieOfLivreListNewLivre);
                    }
                }
            }
            em.getTransaction().commit();
